...
Namespace CustomProvider
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			Dim imageTilesLayer As New ImageTilesLayer()
		...
		Public Class LocalTileSource
			...
			Public Sub New(ByVal cacheOptionsProvider As ICacheOptionsProvider)
				MyBase.New(CInt(Fix(CalculateTotalImageSize(maxZoomLevel))), CInt(Fix(CalculateTotalImageSize(maxZoomLevel))), tileSize, tileSize, cacheOptionsProvider)
